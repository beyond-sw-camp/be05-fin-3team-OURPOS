      ...
      <v-row>
        <v-col cols="9">
          <v-card class="pa-4 order-list">
            <v-row>
              ...
              <v-col>
                <v-btn :color="selectedTab === '완료' ? 'light-green' : 'white'" @click="selectTab('완료')">
                  완료
                </v-btn>
              </v-col>
            </v-row>
        ...
        <v-col cols="3">
          <v-card class="pa-4 order-detail">
            ...
            <v-divider class="my-2"></v-divider>
            <v-btn color="primary" class="mt-2" @click="acceptOrder">주문수락</v-btn>
...
const orders = ref([
  {
    id: 1, date: '2023-06-09 12:00', elapsedTime: '10분', amount: '10,000원', status: '대기',
  ...
  {
    id: 2, date: '2023-06-09 12:05', elapsedTime: '5분', amount: '8,000원', status: '대기',
