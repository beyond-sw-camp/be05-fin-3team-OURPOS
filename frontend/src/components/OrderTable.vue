      ...
      <v-dialog v-model="dialog" max-width="600px">
        <v-card>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn
              v-if="selectedOrder.storeOrderStatus === 'WAITING'"
              color="blue darken-1"
            ...
            <v-btn
              v-if="selectedOrder.storeOrderStatus === 'ACCEPTED'"
              color="blue darken-1"
            ...
            <v-btn
              v-if="selectedOrder.storeOrderStatus === 'DELIVERING'"
              color="blue darken-1"
