      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body" v-if="selectedOrder">
            ...
            <p><strong>주문 날짜:</strong> {{ (selectedOrder.storeOrderDate.approvedAt).toLocaleString() }}</p>
            <p><strong>주문 가격:</strong> {{ (selectedOrder.storeOrderPrice.balanceAmount).toLocaleString() }}</p>
