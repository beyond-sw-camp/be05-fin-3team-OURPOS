                ...
                <ul class="list-group">
                  <li v-for="order in orders" :key="order.orderId" class="list-group-item">
                    <div class="row">
                      ...
                      <div class="col"><strong>주문 일시:</strong> {{ order.orderCreatedDateTime(jsonData.approvedAt).toLocaleString() }}</div>
                      <div class="col"><strong>경과 시간:</strong> {{ order.formattedCookingTime }}</div>
                      <div class="col"><strong>주문 금액:</strong> {{ order.price(jsonData.balanceAmount).toLocaleString() }} 원</div>
                      <div class="col">
            ...
            <div class="card order-detail-card">
              <div class="card-body">
                ...
                <div v-if="Array.isArray(selectedOrderDetail.orderDetailResponseDtos)">
                  <div v-for="(detail, index) in selectedOrderDetail.orderDetailResponseDtos" :key="index" class="order-item">
