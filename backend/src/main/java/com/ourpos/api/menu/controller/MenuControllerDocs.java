...
public interface MenuControllerDocs {
    ...
    Result<Void> deactivateMenu(
        @Parameter(name = "storeRestrictedMenuRequestDto", description = "비활성화고자 하는 메뉴의 id")
        @RequestPart @Valid StoreRestrictedMenuRequestDto storeRestrictedMenuRequestDto);

    @Operation(summary = "특정 점포의 메뉴 활성화", description = "특정 점포의 특정 메뉴를 활성화 합니다.")
    Result<Void> activateMenu(
        @Parameter(name = "storeRestrictedMenuRequestDto", description = "활성화하고자 하는 메뉴의 id")
        @RequestPart @Valid StoreRestrictedMenuRequestDto storeRestrictedMenuRequestDto);
